...
## Upcoming Projects
I am currently working on enhancing the Security Operations Center (SOC) environment by integrating a Security Orchestration, Automation, and Response (SOAR) platform by deploying the proper tools using Docker containers on an Ubuntu server. This deployment will include three key tools: TheHive, Cortex, and MISP.
